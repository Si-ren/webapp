...
type Base struct {
	BaseId       int       `json:"base_id" gorm:"primaryKey;autoIncrement;comment:BaseId;not null"` // BaseId
	InstanceId   int       `json:"instance_id" gorm:"comment:实例ID;not null"`                        // 实例ID
	SyncAt       int       `json:"sync_at,omitempty" gorm:"autoCreateTime;comment:同步时间"`            // 同步时间
	Vendor       int       `json:"vendor" gorm:"comment:厂商;not null"`                               // 厂商
...
type Resource struct {
	ResourceId  int       `json:"resource_id,omitempty" gorm:"primaryKey;autoIncrement;comment:ResourceId;not null"` // ResourceId
...
type Describe struct {
	DescribeId              int    `json:"describe_id,omitempty" gorm:"primaryKey;autoIncrement;comment:关联DescribeId;size:255"` // 关联DescribeId
